...
public class Solution {
    public class TableInterfaceWrapper implements ATableInterface{
        private ATableInterface ifaceWraper;

        public TableInterfaceWrapper(ATableInterface o){
            super();
            this.ifaceWraper = o;
        }
        ...
        public void setModel(List rows) {
            ...
            ifaceWraper.setModel(rows);
        }

        @Override
        public String getHeaderText() {
            return ifaceWraper.getHeaderText().toUpperCase();
        }

        @Override
        public void setHeaderText(String newHeaderText) {
            ifaceWraper.setHeaderText(newHeaderText);
        }
    }
