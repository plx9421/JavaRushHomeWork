...
public class Solution
{
    ...
    {
        Number number = new Number(NumerationSystemType._2, "11010010000000011000010011101101111111001100101010001001110110110110010010110011000110011000001");
    ...
    {
        BigInteger b2 = new BigInteger(number.getDigit(), number.getNumerationSystem().getNumerationSystemIntValue());

        return new Number(expectedNumerationSystem, b2.toString(expectedNumerationSystem.getNumerationSystemIntValue()));
    }
}
