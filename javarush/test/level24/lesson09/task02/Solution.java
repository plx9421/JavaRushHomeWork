    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (nameStock1 == null || nameStock2 == null) return -1;
                int result;
                if ((result = nameStock1.compareTo((nameStock2))) == 0) {
                    Date dateStock1 = (Date) stock1.get("date");
                    Date dateStock2 = (Date) stock2.get("date");
                    if (dateStock1 == null || dateStock2 == null) return -1;
                    SimpleDateFormat df = new SimpleDateFormat("yyyyMMdd");

                    if ((result = df.format(dateStock1).compareTo(df.format(dateStock2))) == 0) {
                        double open;
                        double last;
                        double profit1;
                        double profit2;
