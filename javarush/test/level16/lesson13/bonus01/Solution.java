...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(ImageReaderFactory.getReader(ImageTypes.JPG));
        System.out.println(ImageReaderFactory.getReader(ImageTypes.BMP));
        System.out.println(ImageReaderFactory.getReader(ImageTypes.PNG));
        System.out.println(ImageReaderFactory.getReader(null));
