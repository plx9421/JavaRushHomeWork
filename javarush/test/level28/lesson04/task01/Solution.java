...
{
    private final static AtomicInteger fabricNumber = new AtomicInteger(0);

    public static class AmigoThreadFactory implements ThreadFactory
    {
        private AtomicInteger factoryNumber = new AtomicInteger(0);
        private AtomicInteger factoryThreadNumber = new AtomicInteger(0);
        ...
        public Thread newThread(Runnable r) {
            ...
            thread.setName(thread.getThreadGroup().getName() + "-pool-" + factoryNumber + "-thread-" + factoryThreadNumber.incrementAndGet());
