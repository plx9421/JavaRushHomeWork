...
import com.javarush.test.level32.lesson08.home01.CustomInvocationHandler;
...
public class Solution {
    ...
    public <T extends Item> T getProxy(Class<T> itemClass, Class<?> ... originInterfaces)
    {
        Class[] interfaces = new Class[originInterfaces.length +1];

        System.arraycopy(originInterfaces, 0, interfaces, 0, originInterfaces.length);
