...
public class Solution {
    ...
    public static void readKeyFromConsoleAndInitPlanet() {
        ...
        thePlanet = null;
        if (Sun.EARTH.equals(inputLine))thePlanet = Earth.getInstance();
        if (Sun.MOON.equals(inputLine))thePlanet = Moon.getInstance();
        if (Sun.SUN.equals(inputLine))thePlanet = Sun.getInstance();
    }
}
